...
`)
.addField(`\<a:ileriok:836115367910834206>   **Minecraft IP Sistemi**`,` \Sunucu IP  İncelemek İçin ***sunucuip <ip>** Yazabilirsin.`,true)
.addField(`\<a:ileriok:836115367910834206>   **Koronavirüs Vaka Sistemi**`,`\ Vakalara Bakmak İçin ***korona** Yazabilirsin.\ `,true)
.addField(`\<a:ileriok:836115367910834206>   **Exec Sistemi**`,`\Geliştirici Komutudur,Kullanılmaz. `,true)
.addField(`\<a:ileriok:836115367910834206>  **Korona Tedbir**`,`\Tedbir Bilgi İçin ***tedbir** Yazabilirsin. `,true)
.addField(`\<a:ileriok:836115367910834206>  **Deprembilgi**`,`\Deprem Bilgi İçin ***deprembilgi** Yazabilirsin. `,true)
